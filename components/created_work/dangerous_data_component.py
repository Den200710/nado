...
class DangerousDataComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self._locators = {
            ...
            'work_kind': page.locator("(//div[contains(@class,'parameters-card_item_value')]/span)[5]"),
            'work_plan': page.locator("(//div[contains(@class,'parameters-card_item_value')])[10]"),
            ...
            'specificity': page.locator("(//div[contains(@class,'parameters-card_item_value')])[11]"),
